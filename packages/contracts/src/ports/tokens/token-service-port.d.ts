...
import type { JwtDescriptor, MintAccessTokenInput, MintDecisionJwtInput, MintRefreshTokenInput, TokenPair } from "../../types/token.js";
export interface TokenServicePort {
    ...
    mintTokenPair(accessInput: MintAccessTokenInput, refreshInput: MintRefreshTokenInput): Promise<Result<TokenPair, CatalystError>>;
}
//# sourceMappingURL=token-service-port.d.ts.map