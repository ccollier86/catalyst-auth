...
import type { IssueKeyInput, KeyOwnerReference, KeyRecord, KeyUsageOptions, ListKeysOptions, RevokeKeyInput } from "../../types/key.js";
export interface KeyStorePort {
    ...
    listKeysByOwner(owner: KeyOwnerReference, options?: ListKeysOptions): Promise<Result<ReadonlyArray<KeyRecord>, CatalystError>>;
...
//# sourceMappingURL=key-store-port.d.ts.map