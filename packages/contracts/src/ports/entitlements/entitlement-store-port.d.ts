...
export interface EntitlementStorePort {
    ...
    listEntitlementsForSubjects(subjects: ReadonlyArray<EntitlementQuery>): Promise<ReadonlyArray<EntitlementRecord>>;
    upsertEntitlement(entitlement: EntitlementRecord): Promise<EntitlementRecord>;
    removeEntitlement(id: string): Promise<void>;
}
//# sourceMappingURL=entitlement-store-port.d.ts.map